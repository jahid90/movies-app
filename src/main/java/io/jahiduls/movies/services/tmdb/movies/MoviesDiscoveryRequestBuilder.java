...
import io.jahiduls.movies.services.tmdb.movies.MoviesDiscovery.Request;
...
public class MoviesDiscoveryRequestBuilder {
    ...
    public MoviesDiscovery.Request build() {
        ...
        final WebClient client = clientFactory.webClientOf(tmdbConfiguration.baseUrl() + DISCOVERY_PATH);
